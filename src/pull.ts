...
export function compileRecallRulesBlock(): string {
    const lines = [
        ...
        '',
        '**Important:** All team knowledge (`.teamai/team-repo/`, including',
        '`learnings/` and `docs/team-codebase/`) **must** be accessed exclusively',
        'through the `teamai-recall` subagent, which handles indexing, ranking,',
        'and summarization. If you need more detail on a specific file returned',
        'by recall, you may then Read that file directly.',
        '',
