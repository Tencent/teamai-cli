...
export function compileRecallRulesBlock(): string {
    const lines = [
        ...
        '2. After recall returns, if the results are sufficient to complete the',
        '   task, proceed directly without launching Explore agents.',
        '3. Only if recall results are **insufficient** to solve the problem may',
        '   you then launch Explore agents — but they must not search paths',
        '   already covered by the recall subagent (`.teamai/`, `learnings/`,',
        '   `docs/team-codebase/`).',
        '',
