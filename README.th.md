...
\* การรองรับ Hooks ของ Pi จำกัดเฉพาะบริดจ์วงจรชีวิตที่มากับ TeamAI โดยจะไม่นำ Team Hook แบบกำหนดเองหรือการ override Hook ที่มากับระบบจาก `hooks/hooks.yaml` มาใช้กับ Pi
